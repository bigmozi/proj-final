...
describe ('List.jsx', () => {
    it ('should be able to add a task', () => { 
        ...
        const addedSecondTaskTitle = screen.getByText('Estudar testes')
        expect(addedSecondTaskTitle).toHaveTextContent('Estudar testes')

        
    })


    it ('should not be able to add a empty task', () => {
     ...
     it ('should be able to delete a task', () => {
        ...
        const [addedFirstTaskTitleRemoveButton] = screen.getAllByTestId('remove-task')
        fireEvent.click(addedFirstTaskTitleRemoveButton)
